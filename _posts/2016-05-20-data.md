...
Our alambic server is almost complete, we just need to [create an  request endpoint](http://webtales.github.io/alambic/start/queries) to be able to request it.
